          ...
          <>
            ...
            <div className="section">
              ...
              <input
                ...
                onChange={(e) =>
                  setData({ ...data, nutritionPre: e.target.value })
                }
              />
              ...
              <input
                ...
                onChange={(e) =>
                  setData({ ...data, nutritionDuring: e.target.value })
                }
              />
              ...
              <input
                ...
                onChange={(e) =>
                  setData({ ...data, hydration: e.target.value })
                }
              />
            </div>
          ...
          <>
            ...
            <div className="section compare">
              ...
              <div className="compare-row">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setReview({ ...review, actualPacing: e.target.value })
                  }
                />
              </div>
            </div>
            ...
            <div className="section compare">
              ...
              <div className="compare-row">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setReview({ ...review, actualNutrition: e.target.value })
                  }
                />
              </div>
            </div>
            ...
            <div className="section">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setReview({ ...review, whatWorked: e.target.value })
                }
              />
              ...
              <textarea
                ...
                onChange={(e) =>
                  setReview({ ...review, whatNot: e.target.value })
                }
              />
