...
import { createAthleteGroup, deleteAthleteGroup, getAthleteGroupsByGroupId } from "../../api/athleteGroup"
...
const isDirty =
  JSON.stringify(editData) !== JSON.stringify(group)
...
>
  ...
  onChange={(e) =>
    setEditData({ ...editData, maxAthletes: Number(e.target.value) })
  }
/>
    ) : (
      ...
      <div className="center">
        ...
        <div className="card">
          ...
          <div className="stats-row">
            <div>Weekly Load: <b>320</b></div>
            <div>ACWR: <b>1.1</b></div>
          </div>
        </div>
...
{bestTest && (() => {
  ...
  const spreadClass =
  spreadPercent > 25 ? "high" :
  spreadPercent > 15 ? "medium" :
  "low"
...
<div className="note-header">
  ...
  <div
    ...
    onClick={() =>
      setExpandedNote(isOpen ? null : note.id)
    }
  >
    <b>{note.title}</b>
      ...
      {showModal && (
        <div className="modal-overlay" onClick={() => setShowModal(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <button onClick={handleAddSelected} disabled={selectedAthletes.length === 0}>
